    ...
    <div class="content">
        <div class="single-page">
            <div class="print-main">
                <a href=>{{$new->title}}</a>
                <p class="sub_head">Posted by <a href="#">{{$new->author}}</a> {{date('F j, Y H:i',strtotime($new->created_at))}}</p>
                <a href="#"><img src="{{URL::to('img/uploads/admin/'.$new->picture)}}" class="img-responsive" alt="" /></a>
                <!---728x90--->
                ...
                <div class="comments1">
                    ...
                    <div class="comments-main">
                        <div class="col-md-3 cmts-main-left">
                            <img src="{{URL::to('src/images/avatar.jpg')}}" alt="">
                        </div>
        ...
        <div class="col-md-5 content-right content-right-top">
            ...
            <div class="editors-pic-grids">
                ...
                <div class="editors-pic">
                    <div class="e-pic">
                        <a href="single.html"><img src="{{URL::to('src/images/ep1.jpg')}}" alt="" /></a>
                    </div>
                ...
                <div class="editors-pic">
                    <div class="e-pic">
                        <a href="single.html"><img src="{{URL::to('src/images/ep2.jpg')}}" alt="" /></a>
                    </div>
                    <div class="e-pic-info">
                ...
                <div class="editors-pic">
                    <div class="e-pic">
                        <a href="single.html"><img src="{{URL::to('src/images/ep3.jpg')}}" alt="" /></a>
                    </div>
                    <div class="e-pic-info">
                        <a href="single.html">MarkerBot Announces the ‘Replicator 2x’  For the Experimental</a>
                        <span></span>
                ...
                <div class="editors-pic">
                    <div class="e-pic">
                        <a href="single.html"><img src="{{URL::to('src/images/ep4.jpg')}}" alt="" /></a>
                    </div>
                    <div class="e-pic-info">
                        <a href="single.html">3D Printed Record – the next revolution?</a>
                        <span></span>
